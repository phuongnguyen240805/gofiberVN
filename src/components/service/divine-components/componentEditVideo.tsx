...
import { CATEGORIES_DATA, EDIT_DATA } from "@/data/category";
...
const ComponentEditVideo = () => {
  const brands: Brand[] = [
    { id: 'canva', name: 'Canva', logoText: 'Canva Pro', textColor: 'text-cyan-400' },
    { id: 'adobe', name: 'Adobe', logoText: 'Creative Cloud', textColor: 'text-red-500' },
    { id: 'capcut', name: 'CapCut', logoText: 'CapCut Pro', textColor: 'text-white' },
  ];

  const products: Product[] = [
    {
      id: 1,
      name: 'Sản phẩm Canva Pro (Nâng cấp chính chủ)',
      discount: '79%',
      price: '249.000đ',
      imageUrl: 'https://framerusercontent.com/images/c81Uv0JiG6yEz6OvnZ5EFBsrTcY.jpg?scale-down-to=512',
      bgGradient: 'from-cyan-900/40 to-black',
    },
    {
      id: 2,
      name: 'Sản phẩm Adobe All Apps (Chính chủ)',
      discount: '90%',
      price: '1.450.000đ',
      imageUrl: 'https://framerusercontent.com/images/tzNbMK5gBWrsHwR1RMwZK1sNqLY.jpg?scale-down-to=512&width=690&height=323',
      bgGradient: 'from-red-900/30 to-zinc-900',
    },
    {
      id: 3,
      name: 'Sản phẩm CapCut Pro 1 năm',
      discount: '80%',
      price: '490.000đ',
      imageUrl: 'https://framerusercontent.com/images/36yt4OywsW5MWRzUM0XdAOSZAgA.jpg?scale-down-to=512&width=690&height=323',
      bgGradient: 'from-zinc-700 to-black',
    }
  ];
