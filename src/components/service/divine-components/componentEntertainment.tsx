...
const ComponentEntertainment = () => {
  const brands: Brand[] = [
    { id: 'netflix', name: 'Netflix', logoText: 'NETFLIX', textColor: 'text-red-600' },
    { id: 'iqiyi', name: 'iQIYI', logoText: 'iQIYI', textColor: 'text-emerald-400' },
    { id: 'spotify', name: 'Spotify', logoText: 'Spotify', textColor: 'text-green-500' },
    { id: 'calm', name: 'Calm', logoText: 'Calm', textColor: 'text-blue-400' },
    { id: 'youtube', name: 'YouTube', logoText: 'Premium', textColor: 'text-white' },
  ];

  const products: Product[] = [
    {
      id: 1,
      name: 'Sản phẩm Netflix Premium',
      discount: '85%',
      price: '19.000đ',
      imageUrl: 'https://framerusercontent.com/images/9iTj18sBPLVpYvz0snHsOfbbsE.jpg?scale-down-to=512',
      bgGradient: 'from-zinc-900 to-black',
    },
    {
      id: 2,
      name: 'Sản phẩm Youtube Premium',
      discount: '92%',
      price: '720.000đ',
      imageUrl: 'https://framerusercontent.com/images/CjrJio5uBlGiqt7fvi4kqBKsxMw.jpg?scale-down-to=512&width=690&height=323',
      bgGradient: 'from-red-900/20 to-zinc-900',
    },
    {
      id: 3,
      name: 'Sản phẩm Spotify Premium',
      discount: '54%',
      price: '399.000đ',
      imageUrl: 'https://framerusercontent.com/images/fmXxamEtMwpdYln4MczSeGdWGw.jpg?scale-down-to=512&width=690&height=323',
      bgGradient: 'from-green-900/20 to-zinc-900',
    },
    {
      id: 4,
      name: 'Sản phẩm iQIYI Premium',
      discount: '87%',
      price: '39.000đ',
      imageUrl: 'https://framerusercontent.com/images/OqZtHYwOdvYrPoPwA5PwnZ9bi0U.jpg?scale-down-to=512',
...
export default ComponentEntertainment;