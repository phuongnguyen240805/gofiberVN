...
import { CATEGORIES_DATA, GIFT_CARD_DATA } from "@/data/category";
...
const ComponentGiftCard = () => {
  const brands: Brand[] = [
    { id: 'steam-wallet', name: 'Steam', logoText: 'Steam', textColor: 'text-slate-400' },
    { id: 'xbox-gift', name: 'Xbox', logoText: 'Xbox US', textColor: 'text-emerald-500' },
    { id: 'ea-gift', name: 'EA App', logoText: 'EA Gift', textColor: 'text-orange-400' },
  ];

  const products: Product[] = [
    {
      id: 1,
      name: 'Steam Wallet Code 500 THB (Thái Lan)',
      discount: '10%',
      price: '360.000đ',
      imageUrl: 'https://framerusercontent.com/images/gBDxQRto4Mj5Mqcm7rdbkOzLDrA.jpg?scale-down-to=512&width=690&height=323g',
      bgGradient: 'from-slate-700/40 via-zinc-900 to-black',
    },
    {
      id: 2,
      name: 'Steam Wallet Code 10 SGD (Singapore)',
      discount: '8%',
      price: '185.000đ',
      imageUrl: 'https://framerusercontent.com/images/gBDxQRto4Mj5Mqcm7rdbkOzLDrA.jpg?scale-down-to=512&width=690&height=323g',
      bgGradient: 'from-blue-800/20 via-zinc-900 to-black',
    },
    {
      id: 3,
      name: 'Xbox Gift Card $10 US (Mã nạp ngay)',
      discount: '8%',
      price: '240.000đ',
      imageUrl: 'https://framerusercontent.com/images/Fq2tyq1HR1EMISdq5A51RL0IGd4.jpg?scale-down-to=512',
      bgGradient: 'from-emerald-600/30 via-zinc-900 to-black',
    },
    {
      id: 4,
      name: 'EA Gift Card $25 (Dành cho PC)',
      discount: '5%',
      price: '615.000đ',
      imageUrl: 'https://framerusercontent.com/images/FrOHAjK6V6jEfguMAjD0Y8L1Cg.jpg?scale-down-to=512',
...
export default ComponentGiftCard;