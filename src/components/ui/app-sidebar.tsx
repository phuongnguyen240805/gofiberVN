...
const items = [
  ...
  },
  {
    ...
    child: [
      ...
      {
        title: 'Create Ticket',
        url: '/account/support/create-tickets',
        icon: MdOutlineSupportAgent,
      },
    ],
    icon: MdOutlineSupportAgent,
    ...
    <>
      ...
      >
        <div className="flex border-r border-gray-200 lg:border-[#e5e7eb]">
          <div
            ref={mainSidebarRef}
            className="flex w-fit bg-white/85 lg:bg-transparent"
          >
            <Sidebar
              collapsible="none"
              className="sticky left-0 top-0 h-screen w-[90px] bg-white lg:bg-transparent"
              variant="sidebar"
            >
              <SidebarContent>
                <SidebarGroup className="p-0">
                  <SidebarGroupContent>
                    ...
                    <SidebarMenu className="h-full items-center gap-0 pt-14 lg:pt-14">
                      {items.map((item, index) => (
                        ...
                        >
                          <SidebarMenuButton
                            asChild
                            className="h-fit w-full py-0 hover:bg-transparent"
                          >
                            {item.child ? (
                              <button
          ...
          {activeSidebar && (
            <div ref={sidebarRef} className="relative">
              <Sidebar
                collapsible="none"
                className="sticky left-0 top-0 z-50 h-screen w-48 bg-white pt-[52px] md:pt-0 lg:pt-14"
                variant="sidebar"
              >
                <SidebarContent>
                  <SidebarGroup className="p-0">
              ...
              <Button
                className="absolute -right-5 top-4 z-50 hidden h-10 w-10 rounded-full bg-blue-500 p-4 text-white hover:bg-blue-500 hover:text-white lg:block"
                variant={'ghost'}
