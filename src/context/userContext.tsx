...
export const accessToken = window?.localStorage?.getItem('medusa_jwt') || '';
console.log('Access Token from userContext:', accessToken);
// 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..yCscI2GuZRhm93Mf4zWWW_n85X7gKoxUs-k05N63oQk'
