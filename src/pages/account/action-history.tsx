...
const ActionHistoryPage = () => {
    ...
    return (
        <div className="flex flex-col gap-6">
            <Breadcumb title="Action History" />
            ...
            <div className="flex w-full flex-col gap-4 rounded-2xl bg-white p-4 py-6 shadow-sm">
                ...
                <div className="hidden w-full flex-wrap items-start gap-4 lg:flex">
                    <div className="hidden lg:block">
                        <input
                            type="text"
                            placeholder="Enter an action to search"
                            value={searchValue}
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="overflow-hidden rounded-xl">
                                    <th className="overflow-hidden border-b-0 bg-gray-100 py-3 first:rounded-l-xl last:rounded-r-xl min-w-[300px]">
                                        <div className="flex items-center justify-center">Action</div>
                                    </th>
                                    <th className="overflow-hidden border-b-0 bg-gray-100 py-3 first:rounded-l-xl last:rounded-r-xl min-w-[150px]">
                                        <div className="flex items-center justify-center">Status</div>
                                    </th>
                                    <th className="overflow-hidden border-b-0 bg-gray-100 py-3 first:rounded-l-xl last:rounded-r-xl min-w-[150px]">
                                        <div className="flex items-center justify-center">IP address</div>
                                    </th>
                                    <th className="overflow-hidden border-b-0 bg-gray-100 py-3 first:rounded-l-xl last:rounded-r-xl">
                                        <div className="flex items-center justify-center">FP</div>
                                    </th>
                                    <th className="overflow-hidden border-b-0 bg-gray-100 py-3 first:rounded-l-xl last:rounded-r-xl min-w-[150px]">
                                        <div className="flex items-center justify-center">Date succeed</div>
                                    </th>
                                    <th className="overflow-hidden border-b-0 bg-gray-100 py-3 first:rounded-l-xl last:rounded-r-xl min-w-[150px]">
                                        <div className="flex items-center justify-center">Date created</div>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
...
ActionHistoryPage.getLayout = function getLayout(page: ReactElement) {
    return (
        <PrimaryLayout seo={{ title: 'Action History', canonical: '/account/action-history' }}>
            {page}
        </PrimaryLayout>
    );
};
