        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col rounded-2xl bg-white shadow-sm">
                <div className="flex items-center gap-2 rounded-t-2xl border-b border-gray-200 bg-white px-3 py-2 text-sm max-sm:py-3">
                    ...
                    <span className="text-base font-semibold text-blue-600">Open Ticket</span>
                </div>

                <div className="p-4">
                    <div className="flex flex-wrap gap-4">
                        {/* Name - Disabled */}
                        <div className="group relative w-full pointer-events-none opacity-50">
                        ...
                        <div className="relative w-full max-sm:min-w-full lg:min-w-[320px] lg:w-[calc(50%-8px)]">
                            ...
                            <label className="absolute left-3 top-1/2 -translate-y-1/2 bg-white px-2 text-sm text-gray-500 peer-focus:top-0 peer-focus:-translate-y-[calc(100%+8px)] peer-[:not([value=''])]:top-0 peer-[:not([value=''])]-translate-y-[calc(100%+8px)]">
                                Department
                            </label>
                        ...
                        <div className="flex w-full flex-col">
                            ...
                            <textarea
                                ...
                                className="w-full min-h-[200px] rounded-lg border border-gray-300 px-3 py-2.5 text-sm shadow-sm outline-none transition-colors hover:border-gray-400 focus:border-gray-900 resize-y"
                                ...
                                <div className="flex flex-1 flex-col">
                                    <div className="mb-4 flex w-full flex-col last:mb-0">
                                        <div className="flex flex-1 flex-wrap items-center gap-2">
                                            ...
                                            <label
                                                htmlFor="file-upload"
                                                className="flex cursor-pointer items-center gap-2 rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 transition-colors"
                                            >
                        ...
                        <div className="my-4 w-full rounded-xl bg-blue-50 p-3">
                            <p className="text-xs italic text-blue-600">
                                Allowed File Extensions: .jpg, .JPG, .gif, .GIF, .jpeg, .JPEG, .png, .PNG, .bmp, .BMP, .pdf, .PDF, .doc, .DOC, .txt, .TXT, .zip, .ZIP, .rar, .RAR, .tar, .gz, .tgz, .log, .tiff, .TIFF, .docx, .xlsx, .csv
                            </p>
                        </div>
                        ...
                        <button
                            type="button"
                            className="flex items-center gap-2 rounded-full border border-blue-600 bg-white px-4 py-2 text-sm font-medium text-blue-600 hover:bg-blue-600 hover:text-white transition-colors"
                        >
